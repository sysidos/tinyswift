    ...
    namespace NewMangling {
        ...
        NodePointer Demangler::demangleOperator() {
            switch (char c = nextChar()) {
                ...
                case 'C':
                    return demangleNominalType(Node::Kind::Class);
                case 'D':
                    return createWithChild(Node::Kind::TypeMangling,
                ...
                case 'K':
                    return NodeFactory::create(Node::Kind::ThrowsAnnotation);
                case 'L':
                    return demangleLocalIdentifier();
                case 'M':
                    return demangleMetatype();
                case 'N':
                    return createWithChild(Node::Kind::TypeMetadata,
                                           popNode(Node::Kind::Type));
                case 'O':
                    return demangleNominalType(Node::Kind::Enum);
                case 'P':
                    return demangleNominalType(Node::Kind::Protocol);
                case 'Q':
                    return demangleArchetype();
                case 'R':
                    return demangleGenericRequirement();
                case 'S':
                    return demangleKnownType();
                case 'T':
                    return demangleThunkOrSpecialization();
                case 'V':
                    return demangleNominalType(Node::Kind::Structure);
                case 'W':
                    return demangleWitness();
                case 'X':
                    return demangleSpecialType();
                case 'Z':
                    return createWithChild(Node::Kind::Static, popNode(isEntity));
                case 'a':
                    return demangleTypeAlias();
                case 'c':
                    return popFunctionType(Node::Kind::FunctionType);
                case 'd':
                    return NodeFactory::create(Node::Kind::VariadicMarker);
                case 'f':
                    return demangleFunctionEntity();
                case 'i':
                    return demangleEntity(Node::Kind::Subscript);
                case 'l':
                    return demangleGenericSignature(/*hasParamCounts*/ false);
                case 'm':
                    return createType(createWithChild(Node::Kind::Metatype,
                                                      popNode(Node::Kind::Type)));
                case 'o':
                ...
                case 'q':
                    return createType(demangleGenericParamIndex());
                case 'r':
                    return demangleGenericSignature(/*hasParamCounts*/ true);
                case 's':
                ...
                case 'v':
                    return demangleEntity(Node::Kind::Variable);
                case 'w':
                    return demangleValueWitness();
                case 'x':
                    return createType(getDependentGenericParamType(0, 0));
                case 'y':
                    return NodeFactory::create(Node::Kind::EmptyList);
                case 'z':
                    return createType(createWithChild(Node::Kind::InOut,
                                                      popTypeAndGetChild()));
                case '_':
                    return NodeFactory::create(Node::Kind::FirstElementMarker);
                default:
                    pushBack();
            ...
            switch (nextChar()) {
                ...
                case 'g':
                    return createType(createWithChildren(Node::Kind::BoundGenericEnum,
                                                         ...
                                                         createWithChild(Node::Kind::TypeList,
                                                                         popNode(Node::Kind::Type))));
                default:
                    return nullptr;
            }
        ...
        NodePointer Demangler::demangleOperatorIdentifier() {
            ...
            switch (nextChar()) {
                case 'i':
                    return NodeFactory::create(Node::Kind::InfixOperator, OpStr);
                case 'p':
                    return NodeFactory::create(Node::Kind::PrefixOperator, OpStr);
                case 'P':
                    return NodeFactory::create(Node::Kind::PostfixOperator, OpStr);
                default:
                    return nullptr;
            }
        }
                ...
                case 'v': {
                    ...
                    Ty = NodeFactory::create(Node::Kind::BuiltinTypeName,
                                             (DemanglerPrinter() << "Builtin.Vec" << elts << "x" <<
                                                                 EltType->getText().substr(
                                                                         sizeof("Builtin.") - 1)).str());
                    break;
                }
                case 'O':
                    Ty = NodeFactory::create(Node::Kind::BuiltinTypeName,
        ...
        NodePointer Demangler::demangleThunkOrSpecialization() {
            switch (char c = nextChar()) {
                case 'c':
                    return createWithChild(Node::Kind::CurryThunk, popNode(isEntity));
                case 'o':
                    return NodeFactory::create(Node::Kind::ObjCAttribute);
                case 'O':
                    return NodeFactory::create(Node::Kind::NonObjCAttribute);
                case 'D':
                    return NodeFactory::create(Node::Kind::DynamicAttribute);
                case 'd':
                    return NodeFactory::create(Node::Kind::DirectMethodReferenceAttribute);
                case 'V':
                    return NodeFactory::create(Node::Kind::VTableAttribute);
                case 'a':
                    return NodeFactory::create(Node::Kind::PartialApplyObjCForwarder);
                case 'A':
                    return NodeFactory::create(Node::Kind::PartialApplyForwarder);
                case 'W': {
        ...
        NodePointer Demangler::demangleWitness() {
            switch (nextChar()) {
                ...
                case 'v': {
                    ...
                    switch (nextChar()) {
                        case 'd':
                            Directness = unsigned(Directness::Direct);
                            break;
                        case 'i':
                            Directness = unsigned(Directness::Indirect);
                            break;
                        default:
                            return nullptr;
                    }
        ...
        NodePointer Demangler::demangleFunctionEntity() {
            enum {
                None, Type, TypeAndName, TypeAndIndex, Index
            } Args;
            ...
            switch (nextChar()) {
                case 'D':
                    Args = None;
                    Kind = Node::Kind::Deallocator;
                    break;
                case 'd':
                    Args = None;
                    Kind = Node::Kind::Destructor;
                    break;
                case 'E':
                    Args = None;
                    Kind = Node::Kind::IVarDestroyer;
                    break;
                case 'e':
                    Args = None;
                    Kind = Node::Kind::IVarInitializer;
                    break;
                case 'i':
                    Args = None;
                    Kind = Node::Kind::Initializer;
                    break;
                case 'C':
                    Args = Type;
                    Kind = Node::Kind::Allocator;
                    break;
                case 'c':
                    Args = Type;
                    Kind = Node::Kind::Constructor;
                    break;
                case 'g':
                    Args = TypeAndName;
                    Kind = Node::Kind::Getter;
                    break;
                case 'G':
                    Args = TypeAndName;
                    Kind = Node::Kind::GlobalGetter;
                    break;
                case 's':
                    Args = TypeAndName;
                    Kind = Node::Kind::Setter;
                    break;
                case 'm':
                    Args = TypeAndName;
                    Kind = Node::Kind::MaterializeForSet;
                    break;
                case 'w':
                    Args = TypeAndName;
                    Kind = Node::Kind::WillSet;
                    break;
                case 'W':
                    Args = TypeAndName;
                    Kind = Node::Kind::DidSet;
                    break;
                case 'a':
                    Args = TypeAndName;
                    switch (nextChar()) {
                        case 'O':
                            Kind = Node::Kind::OwningMutableAddressor;
                            break;
                        case 'o':
                            Kind = Node::Kind::NativeOwningMutableAddressor;
                            break;
                        case 'P':
                            Kind = Node::Kind::NativePinningMutableAddressor;
                            break;
                        case 'u':
                            Kind = Node::Kind::UnsafeMutableAddressor;
                            break;
                        default:
                            return nullptr;
                    }
                ...
                case 'l':
                    ...
                    switch (nextChar()) {
                        case 'O':
                            Kind = Node::Kind::OwningAddressor;
                            break;
                        case 'o':
                            Kind = Node::Kind::NativeOwningAddressor;
                            break;
                        case 'p':
                            Kind = Node::Kind::NativePinningAddressor;
                            break;
                        case 'u':
                            Kind = Node::Kind::UnsafeAddressor;
                            break;
                        default:
                            return nullptr;
                    }
                ...
                case 'U':
                    Args = TypeAndIndex;
                    Kind = Node::Kind::ExplicitClosure;
                    break;
                case 'u':
                    Args = TypeAndIndex;
                    Kind = Node::Kind::ImplicitClosure;
                    break;
                case 'A':
                    Args = Index;
                    Kind = Node::Kind::DefaultArgumentInitializer;
                    break;
                case 'p':
                    return demangleEntity(Node::Kind::GenericTypeParamDecl);
                default:
                    return nullptr;
            }
        ...
        NodePointer Demangler::demangleGenericRequirement() {
            ...
            enum {
                Generic, Assoc, CompoundAssoc, Substitution
            } TypeKind;
            enum {
                Protocol, BaseClass, SameType, Layout
            } ConstraintKind;
